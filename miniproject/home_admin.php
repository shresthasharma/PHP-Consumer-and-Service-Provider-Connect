...
<div class="collapse navbar-collapse" id="myMenu">
    <ul class="navbar-nav pl-5 custom-nav">
        ...
        <li class="nav-item"><a href="adminreg.php" class="nav-link">Registration</a></li>
    ...
    <div class="row ">
        <div class="col-sm-4 bg-light sidebar py-5 ">
            <div class="sidebar-sticky">
                ...
                <li class="nav-item"><a class="nav-link"
                href="dispuser.php"><i class="fab fa-accessible-icon fa-8x"></i>User Details</a></li>

                <li class="nav-item"><a class="nav-link"
                href="servlist.php"><i class="fas fa-history fa-8x"></i>Service List</a></li>
